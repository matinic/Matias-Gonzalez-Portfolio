...
export default function Home(){
    ...
    return(
        <div className="bg-teal-200 pt-12 px-6 pb-16">
                ...
                <h1 className="text-teal-600 text-5xl font-extrabold mt-8 text-center sm:text-[5rem] md:text-[6.5rem]">MATIAS GONZALEZ</h1>
                ...
                <h1 className="text-teal-600 mb-4 text-2xl font-bold text-center" id="conocimientos">CONOCIMIENTOS</h1>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <div className="bg-teal-600 p-4 rounded-xl mb-4 shadow-xl text-teal-100">
                            ...
                            <div className="h-56 bg-red-500 rounded-lg bg-proyecto1 bg-contain"></div>
                    ...
                    </div>{/*Fin contenedor de los proyectos*/}
