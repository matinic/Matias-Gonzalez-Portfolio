...
export default function Footer() {
  return (
    <div className="h-24 bg-teal-700 p-4 w-full">
      <h1 className="text-center">© Matias Gonzalez 2024</h1>

      <Link
        className="flex bg-teal-800 justify-center w-max mx-auto p-2 rounded-lg"
        target="_blank"
        href="https://github.com/matinic/Matias-Gonzalez-Portfolio"
      >
